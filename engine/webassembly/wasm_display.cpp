...
static Input::Key keycode_to_key(char const* code)
{
...
static int on_keyboard_event(int event_type, EmscriptenKeyboardEvent const* event, void*)
{
...
static int on_mouse_event(int event_type, EmscriptenMouseEvent const* event, void*)
{
