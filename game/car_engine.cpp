...
void CarEngine::update(Object::GameObject&, float delta)
{
    ...
    m_wheel_transform->set_rotation(glm::vec3(wheel_rotation.x, glm::radians(m_wheel_direction * 30.0f), wheel_rotation.z));
    m_wheel_support_transform->set_rotation(glm::vec3(support_rotation.x, support_rotation.y, glm::radians(m_wheel_direction * 30.0f)));
}
